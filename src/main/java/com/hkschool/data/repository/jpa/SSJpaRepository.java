...
public interface SSJpaRepository extends PagingAndSortingRepository<SSEntity, Long> {
	...
	@Query(nativeQuery=true, value="select * from secondary_school SS where SS.school_type like :schoolCategory and SS.district like :schoolDistrict  and SS.religion like :religion  and SS.student_gender like :studentGender  and SS.sponsoring_body like :sponsoringBody")
