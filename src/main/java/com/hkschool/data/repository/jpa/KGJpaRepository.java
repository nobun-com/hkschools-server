...
public interface KGJpaRepository extends PagingAndSortingRepository<KGEntity, Long> {
	...
	@Query(nativeQuery=true, value="select * from kindergarten_school KG where KG.school_category like :schoolCategoury and KG.district like :schoolDistrict and KG.withchildcareservicesforchildrenagedunder2 like:withchildcareservicesforchildrenagedunder2 and KG.time like:time")
